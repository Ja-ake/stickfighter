 ...
 */
public class Collisions extends SimpleApplication
    ...
    public void simpleInitApp() {
        ...
        player2 = (Node) assetManager.loadModel("Models/Oto/Oto.mesh.xml");
    ...
    public void simpleUpdate(float tpf) {
        ...
        player2.setLocalTranslation(player.getPhysicsLocation().add(10, 0, 0));
    }
